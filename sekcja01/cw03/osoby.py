...
if __name__ == '__main__':
    # Dane wejściowe
    osoba1 = utworz_osobe('Tomasz', 'Kowalski', 'Poznań', True, 22)
    osoba2 = utworz_osobe('Anna', 'Ściborek', 'Szczecin', False, 18)
    osoba3 = utworz_osobe('Łukasz', 'Kowalski', 'Wrocław', True, 30)
    osoba4 = utworz_osobe('Alicja', 'Tarnowska', 'Poznań', False, 25)
    ...
    def klucz_wg_nazwisk(osoba):
        ...
        return locale.strxfrm(osoba['nazwisko'])
